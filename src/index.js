		...
		return (
			<li className={classes}>
				...
				<div className="pull-right" role="group">
					<button type="button" className="btn btn-xs btn-success img-circle" onClick={this.toggleComplete}><span class="glyphicon glyphicon-ok"></span></button>
					<button type="button" className="btn btn-xs btn-danger img-circle" onClick={this.removeNode}><span class="glyphicon glyphicon-remove"></span></button>
					<button type="button" className="btn btn-xs btn-default img-circle" onClick={this.editNode}><span class="glyphicon glyphicon-pencil"></span></button>
				</div>
			</li>
		);
	}
				...
				<div className="clearfix">
					<form className="todoForm form-horizontal" onSubmit={this.doSubmit}>
						<div className="form-group">
							<label htmlFor="task" className="col-md-4 control-label">Add New Task</label>
